...
#JR - March 03. 2013 - The freq range is set to 1460->1480. This causes the
# system to observe at only 1 frequency = 1480. A side affect is that the
# SonATA calibrations go very quickly!

exec setAlarm ARM,sonata,PerseusA
...
db set name {perseusa_1500} current 
...
sched set beginfreq 1410.00 current 
...
sched set endfreq 1430.000000000 current 
...
tscope set sitehoriz 16.500000000 current 
