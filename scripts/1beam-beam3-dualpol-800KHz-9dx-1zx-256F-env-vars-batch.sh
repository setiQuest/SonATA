...
# 1beam-beam3-dualpol-800KHz-9dx-1zx-256F-env-vars-batch
#---------------------------------
...
RUNSSE_CHAN_HOSTS="chanhost3x chanhost3y"
...
# Logical Host Names
RUNSSE_DX_HOSTS="dxhost7 dxhost8 dxhost9"
...
DXHOST7_DX_NAMES="dx3000 dx3001 dx3002"
DXHOST8_DX_NAMES="dx3008 dx3009 dx3010"
DXHOST9_DX_NAMES="dx3016 dx3017 dx3018"
...
DX_OPTS="-f 10 -z $FILTER_DIR/LS256c10f25o70d.flt -F 256 -w .8192 -T 2048"
...
${HOME}/sonata_install/scripts/switchConfigFile-1beam-beam3-800KHz-9dxs-1zx.tcsh
SSE_SETUP="${HOME}/sonata_install/setup/"
export SSE_SETUP
echo $SSE_SETUP
