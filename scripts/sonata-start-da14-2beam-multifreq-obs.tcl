# sonata-start-da14-2beams-8400-8850-obs.tcl
#
# SSE seeker commands to start observing

#JR -= Feb 16, 2013 - I created this to run over different freq ranges by editing
# the values of beginfreq and endfreq

exec setAlarm ARM,sonata,DA14
...
act set targetbeam1 174 current 
act set targetbeam2 175 current 
act set targetbeam3 174 current 
act set targetbeam4 1 current 
act set targetbeam5 1 current 
act set targetbeam6 1 current 
act set targetprimary 174 current 
...
db set name {spacecraft} current 
...
dx set length 186 current 
dx set manualbw {off} current 
dx set maxcand 20 current 
dx set maxdrifttol 10.0 current 
...
sched set beginfreq 7750.00 current 
...
sched set endfreq 8000.000000000 current 
