# sonata-start-rfiscan.tcl
#
# SSE seeker commands to start observing

exec setAlarm ARM,sonata,rfi scan
...
db set name {ldn1622_1500} current 
...
sched set beginfreq 1411.00 current 
sched set catshigh {ldn1622grid} current 
...
sched set endfreq 1488.000000000 current 
...
dx shutdown zx1900,zx2900,zx3900
