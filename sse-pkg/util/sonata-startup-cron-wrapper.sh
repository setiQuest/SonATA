...
envFile="${HOME}/sonata_install/scripts/2beam-dualpol-800KHz-46dx-2zx-env-vars-batch.sh"
#envFile="${HOME}/sonata_install/scripts/3beam-dualpol-800KHz-69dx-3zx-env-vars-batch.sh"
